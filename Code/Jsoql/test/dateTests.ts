...
describe('dateTests', () => {
    ...
    it('DatePartPreservesTimeOffsetFromSourceIfThirdArgumentIsTrue', () => {
    ...
    it('GetDateReturnsSameValueForAllItems', () => {
