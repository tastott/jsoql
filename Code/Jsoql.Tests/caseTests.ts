...
export function CaseExpressionWhenWithNoElse() {
    var query =
        "SELECT \
            Name, \
            CASE Name \
...
export function CaseExpressionWhenWithElse() {
    var query =
        "SELECT \
            Name, \
            CASE Name \
...
export function CaseWhenWithNoElse() {
    var query =
        "SELECT \
            Name, \
            CASE \
...
export function CaseWhenWithElse() {
    var query =
        "SELECT \
            Name, \
            CASE \
